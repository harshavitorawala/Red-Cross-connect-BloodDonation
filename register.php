...
<body id="top">
  ...
  <main>
    <article>
        <section class="section hero" id="home" style="background-image: url('./assets/images/mainbg.jpg'); margin: 0%;" aria-label="hero">
            <div class="container">
              ...
              <video alt="hero banner" class="w-100" autoplay loop>
                ...
                <source src="./assets/images/bg.ogg"  type="video/ogg">
              </video>
            </div>
          </section>
      </article>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="mailto:help@example.com" class="footer-link">redcrossconnect78@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
